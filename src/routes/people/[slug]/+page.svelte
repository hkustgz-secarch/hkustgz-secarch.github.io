				...
				<div class="space-y-1 text-sm">
                    ...
                    <div class="flex flex-wrap gap-3 mt-4">
                        {#if person.googleScholar}
                            <a href={person.googleScholar} target="_blank" rel="noopener noreferrer" class="text-gray-500 hover:text-blue-600 transition-colors" title="Google Scholar">
                        ...
                        {/if}
                        {#if person.github}
                            <a href={person.github} target="_blank" rel="noopener noreferrer" class="text-gray-500 hover:text-gray-900 transition-colors" title="GitHub">
                        ...
                        {/if}
                        {#if person.linkedin}
                            <a href={person.linkedin} target="_blank" rel="noopener noreferrer" class="text-gray-500 hover:text-blue-700 transition-colors" title="LinkedIn">
